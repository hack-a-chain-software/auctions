function CardSkeleton() {
  return <div className="p-4 flex flex-col gap-4 w-[180px] md:w-[302px] bg-white/10 border-[1px] border-outline rounded-[28px] md:rounded-large animate-skeleton-body">

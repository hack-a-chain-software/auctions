...
exports.CONTRACT_MODULE = exports.FAUCET_URL = exports.NODE_URL = exports.moduleName = void 0;
...
exports.CONTRACT_MODULE = CONTRACT_MODULE;
function throwIfUndefined(input) {
    if (input === undefined)
        throw "env not set";
    return input;
}

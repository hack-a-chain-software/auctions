...
function testAptosCoin(client, faucetClient, coinClient, tokenClient) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const auctionHouseClient = new auctionHouseClient_1.AuctionHouseClient(env_1.NODE_URL, moduleAddress.address().hex(), ownerAccount.address().hex());
        // deploy module
    ...
    `);
        ...
        yield client.waitForTransaction(yield auctionHouseClient.initializeAuctionHouse(ownerAccount, true), { checkSuccess: true });
        // authorize aptosCoin
...
exports.testAptosCoin = testAptosCoin;
